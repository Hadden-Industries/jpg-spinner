...
namespace JPG_Spinner
{
	...
	private:
		...
		void HyperLink_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e);
		...
		void PrivacyPolicyButton_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e);
